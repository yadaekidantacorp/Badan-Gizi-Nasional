...
middleware(['auth']);
name('app.ministry.task');
state(['statuses' => fn () => Status::where('type',2)->get()]);
?>
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row row-cols-lg-4 g-10">
                @foreach ($statuses as $item)
                    @php
                        if($item->name == "Belum Dimulai"){
                            $color = "bg-warning";
                        }
                        elseif($item->name == "Daftar Tugas"){
                            $color = "bg-info";
                        }
                        elseif($item->name == "Sedang Berlangsung"){
                            $color = "bg-primary";
                        }
                        elseif($item->name == "Selesai"){
                            $color = "bg-success";
                        }
                    @endphp
                        ...
                        <div class="card draggable mb-6 mb-xl-9">
                            <div class="card-body">
                                <div class="d-flex flex-stack mb-3">
                                    <div class="badge badge-light draggable-handle">UI Design</div>
                                    <div>
                                        <a href="javascript:;" class="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary">
                                            <i class="ki-outline ki-element-plus fs-2"></i>
                                        </a>
